...
/***/ function(module, exports, __webpack_require__) {
	...
	var PeopleTitle = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      'div',
	      { className: 'mbox_filter clearfix' },
	      React.createElement(
	        'h6',
	        null,
	        '按负责人筛选'
	      ),
	      React.createElement('div', { className: 'mbox_filter_close01' })
	    );
	  }
	});
	...
	var PeopleLi = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      'li',
	      { onClick: this.handleClick, ref: 'myLi', ckChecked: this.props.ckChecked },
	      React.createElement(
	        'a',
	        { href: '#', target: '_blank' },
	        React.createElement('img', { src: this.props.Avatar, width: '60', height: '60' })
	      ),
	      React.createElement(
	        'h5',
	        { ref: 'myLiName' },
